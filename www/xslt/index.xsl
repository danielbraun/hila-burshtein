    ...
    hila.burshtein
        ...
        <xsl:template match="treatments-content">
            <div class="panel panel-default">
                <table class="table table-bordered pre-line">
                    <tr>
                        <th>טיפול</th>
                        <th>משך הטיפול</th>
                        <th>מחיר</th>
                    ...
                    <tr>
                        ...
                        <td>90 דקות</td>
                        <td>150 ש״ח</td>
                        <td> הגוף שלנו מורכב ממספר מערכות אשר מתפקדות כיחידה אחת.
...
<tr>
                        <td>טיפול פנים הוליסטי
                        </td>
                        <td>90 דקות</td>
                        <td>250 ש״ח</td>
                        <td> טיפול פנים הוליסטי הוא טיפול שפותח על מנת לשפר את מראה ומרקם העור תוך התחשבות בשכבות העמוקות של העור והתייחסות מלאה לצרכיו האינדיבידואלים.
...
התוצאות של טיפול הפנים ניכרות מיד לאחר הטיפול  – עורך יהיה רך קורן ומלא חיים.
                    ...
                    <tr>
                        ...
                        <td>כ-60 דקות</td>
                        <td>150 ש"ח</td>
                        <td>טיפול זה יחזק ויגמיש את שרירי פניך ובנוסף, הדיקור הקוסמטי אחראי על עידוד היצור הטבעי של סיבי הקולגן והאלסטין ולכן הוא ימצק ויטשטש את קמטי הבעה וקמטי הגיל ויעודד את עורך להיות יותר אלסטי ובעל מראה בריא וקורן.
הטיפול כולל עיסוי פנים בכוסות רוח שישפר את זרימת הדם והספקת החמצן אל עורך.</td>
                    </tr>
                    <tr>
                        <td>טיפול פנים הוליסטי משולב</td>
                        <td>כ-120 דקות</td>
                        <td>300 ש"ח</td>
                        <td>טיפול זה משלב בין טיפול פנים הוליסטי לדיקור קוסמטי.</td>
                    </tr>
                    <tr>
                        <td>ניקוי פנים עמוק</td>
                        <td>כ120 דקות – 150 דקות</td>
                        <td>300 ש"ח</td>
                        <td>טיפול פנים זה ינקה ויטהר את נקבוביות עורך תוך כדי התחשבות בצרכיו המיוחדים, יסיר בעדינות את הקומודונים שהצטברו עליו ויותיר אותו נקי ואסתטי. </td>
                    </tr>
                </table>
            </div>
        </xsl:template>
